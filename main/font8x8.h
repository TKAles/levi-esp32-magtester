...
/*
 * 8x8 bitmap font for printable ASCII 0x20-0x7E (96 glyphs).
 * Index 0  = 0x20 (space), index 95 = 0x7E (~).
 * Each entry is 8 bytes, one byte per row from top to bottom.
 * Bit 7 of each byte is the leftmost pixel.
 *
 * Derived from the classic IBM CP437 8x8 bitmapped font.
 */
